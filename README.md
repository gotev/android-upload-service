...
Upload Service 4.0.0 Alpha 3, 100% Kotlin with:
- Android 10 support
- New *delegates* using AndroidX lifecycle
- and many new features

is here for developer preview! [Check this issue for more information](https://github.com/gotev/android-upload-service/issues/465). For production grade and battle tested version, use 3.5.2.
